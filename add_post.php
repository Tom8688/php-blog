...
$article = filter_input(INPUT_POST, 'article',FILTER_SANITIZE_STRING, FILTER_SANITIZE_STRING, );
...
if( ! $title || mb_strlen($title) < 2 ){
    ...
    $form_valid = false;
    $error['title'] = '* Title is requird for min 2 chars';
}
if( ! $article || mb_strlen($article) < 2 ){

    $form_valid = false;
    $error['article'] = '* Title is requird for min 2 chars';
}
        ...
        <section id="top-content">
            <div class="row">
                <div class="col-12 text-center mt-3">
                    <h1 class="disply-4">Add Your New Post Here!</h1>
